...
func main() {
	...
	rootPath := os.Getenv("PROJ_PATH") // e.g. /home/lgian/go/src/github.com/linosgian/glfw-test2
	...
	// Create a new Shader
	shaderID, err := r.LoadProgram(path.Join(rootPath, vertexPath), path.Join(rootPath, fragmentPath))
	if err != nil {
